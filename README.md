...
# :book: To Do List Project <a name="To Do List"></a>

**To Do List**  The goal of this project was to gain familiarity with webpack and enhance JavaScript skills by creating a simple to-do list application. The project implemented essential features of a to-do list, including adding tasks, removing tasks, editing tasks, and clearing completed tasks. By working on this task, the aim was to improve understanding of webpack bundling and deepen knowledge of JavaScript programming.
...
- [Live Demo Link](https://zuhebahmed88091.github.io/To-Do-List/)
...
```sh
    "git clone https://github.com/zuhebahmed88091/To-Do-List.git"
```
